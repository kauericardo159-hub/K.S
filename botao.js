(function() {
    ...
    estilos.textContent = `
        ...
        .btn-toggle-paineis {
            /* Fundo alterado para preto puro e meio transparente (idêntico aos cards) */
            ...
            align-items: center;
            justify-content: center;
            flex-direction: row; /* Força orientação horizontal */
            gap: 8px;
        ...
        /* ALTERAÇÃO: Interação totalmente limpa e sem cores berrantes */
